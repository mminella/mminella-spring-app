...
```json
{
  ...
  "javaVersion" : "17",
  "projectName" : "mminella-spring-app",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->mminella-spring-app]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: tanzu-java-web-app->: mminella-spring-ap...(truncated)]
